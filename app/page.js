...
const T = {
  Français: {
    ...
    tones: ["Divertissant", "Inspirant", "Éducatif", "Choquant", "Émotionnel"],
  ...
  English: {
    ...
    tones: ["Entertaining", "Inspiring", "Educational", "Shocking", "Emotional"],
  ...
  Español: {
    ...
    tones: ["Entretenido", "Inspirador", "Educativo", "Impactante", "Emocional"],
  ...
  Português: {
    ...
    tones: ["Divertido", "Inspirador", "Educativo", "Chocante", "Emocional"],
